...
using Microservices.CommandService.Data.Dataservice;
using Microservices.CommandService.Data;
using Microservices.CommandService.Data.DBprep;
...
using Microservices.CommandService.AsyncDataService;
    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Microservices.CommandService v1"));
            }
